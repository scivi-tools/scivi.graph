...
var Rect = require('vivagraphjs/src/Utils/rect.js');
 ...
 *
 * @param {Ngraph.Graph.Graph} graph to layout
 * @param {Object} userSettings
 */
export default function constant(graph, userSettings) {
    ...
    return {
         ...
         *
         * @param {Number} [iterationsCount] number of algorithm's iterations.
